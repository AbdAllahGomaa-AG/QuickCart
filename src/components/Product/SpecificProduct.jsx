              ...
              <div className="mt-6 sm:mt-8 lg:mt-0">
                ...
                <div className="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                  ...
                  <a
                    ...
                    title=""
                    className="text-white mt-4 sm:mt-0 bg-purple hover:bg-purple/90 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none flex items-center justify-center"
                    role="button"
                  >
                    <svg
                      className="w-5 h-5 -ms-2 me-2"
                ...
                <hr className="my-2 md:my-8 border-gray-400" />
